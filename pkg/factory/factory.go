...
var registry = map[string]func() checks.Check{
	...
	httpadvanced.CheckName: httpadvanced.NewCheck,
	ssltls.CheckName:       ssltls.NewCheck,
	dnsadvanced.CheckName:  dnsadvanced.NewCheck,
	tcpmeter.CheckName:     tcpmeter.NewCheck,
}
